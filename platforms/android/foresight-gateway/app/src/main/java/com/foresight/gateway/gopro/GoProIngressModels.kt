...
data class GoProRecordingDiagnostics(
    ...
    val firstMuxedKeyframeMonotonicNanos: Long? = null,
    val firstMuxedSourcePtsUs: Long? = null,
    val normalizedMp4OriginPtsUs: Long? = null,
)
...
data class GoProPreviewDiagnostics(
    ...
    val surfaceIdentity: Int? = null,
    val framesQueued: Long = 0,
    val framesRendered: Long = 0,
    val framesDropped: Long = 0,
    val videoAccessUnitsReceived: Long = 0,
    val accessUnitsQueuedToDecoder: Long = 0,
    val outputBuffersProduced: Long = 0,
    val outputBuffersRendered: Long = 0,
    val outputBuffersDropped: Long = 0,
    val decoderErrors: Long = 0,
    val lastInputPtsUs: Long? = null,
    val lastInputElapsedMs: Long? = null,
    val lastRenderedElapsedMs: Long? = null,
    val queueDepth: Int = 0,
    val queueCapacity: Int = 0,
    val detail: String? = null,
)
